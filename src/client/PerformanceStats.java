...
public class PerformanceStats {
    ...
    public PerformanceStats(double memoryUsed, long nodesExplored, long solutionLength, double timeSpent) {
    ...
    public String toString() {
        return String.format(this.formatString, this.memoryUsed, this.timeSpent, this.solutionLength, this.nodesExplored);
    }
}
